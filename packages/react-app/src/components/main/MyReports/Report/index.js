...
// import { GiBabyFace, GiWeightScale, GiBodyHeight } from "react-icons/gi";
...
//                 </div>
//               </Tooltip>
//               {console.log(report[0].generalInfo)}
...
//                       </div>
//                     </Tooltip>
//                     {report[0].generalInfo.gender === "M" ? "Male" : "Female"}
//                     <Tooltip title="Age group">
//                       <div className="border-2 border-gray-600 dark:border-gray-300 rounded-[100%] mx-2 my-2 md:my-0 p-2">
//                         <GiBabyFace />
//                       </div>
//                     </Tooltip>
//                     <p>{report[0].generalInfo.age.toNumber()}</p>
//                     <Tooltip title="Blood Group">
//                       <div className="border-2 border-gray-600 dark:border-gray-300 rounded-[100%] mx-2 my-2 md:my-0 p-2">
//                         <MdBloodtype />
//                       </div>
//                     </Tooltip>
//                     <p>{report[0].generalInfo.bloodGroup}</p>
//                     <Tooltip title="Body Weight">
//                       <div className="border-2 border-gray-600 dark:border-gray-300 rounded-[100%] mx-2 my-2 md:my-0 p-2">
//                         <GiWeightScale />
//                       </div>
//                     </Tooltip>
//                     <p>{report[0].generalInfo.weight.toNumber()}</p>
//                     <Tooltip title="Body Height">
//                       <div className="border-2 border-gray-600 dark:border-gray-300 rounded-[100%] mx-2 my-2 md:my-0 p-2">
//                         <GiBodyHeight />
//                       </div>
//                     </Tooltip>
//                     <p>{report[0].generalInfo.height.toNumber()}</p>
//                   </div>
//                 </div>
//               </div>
//             </div>
